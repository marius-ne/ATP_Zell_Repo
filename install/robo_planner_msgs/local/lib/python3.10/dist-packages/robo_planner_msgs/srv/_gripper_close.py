...
class Metaclass_GripperClose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robo_planner_msgs.srv.GripperClose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robo_planner_msgs.srv import _gripper_close
...
class GripperClose(metaclass=Metaclass_GripperClose):
    from robo_planner_msgs.srv._gripper_close import GripperClose_Request as Request
    from robo_planner_msgs.srv._gripper_close import GripperClose_Response as Response
