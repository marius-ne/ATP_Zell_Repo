...
{
  new (message_memory) robo_planner_msgs::msg::SceneObjectRemove(_init);
}

void SceneObjectRemove_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_planner_msgs::msg::SceneObjectRemove *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SceneObjectRemove_message_member_array[1] = {
  {
    ...
    offsetof(robo_planner_msgs::msg::SceneObjectRemove, name),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SceneObjectRemove_message_members = {
  ...
  1,  // number of fields
  sizeof(robo_planner_msgs::msg::SceneObjectRemove),
...
{
  return &::robo_planner_msgs::msg::rosidl_typesupport_introspection_cpp::SceneObjectRemove_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, msg, SceneObjectRemove)() {
  return &::robo_planner_msgs::msg::rosidl_typesupport_introspection_cpp::SceneObjectRemove_message_type_support_handle;
}
