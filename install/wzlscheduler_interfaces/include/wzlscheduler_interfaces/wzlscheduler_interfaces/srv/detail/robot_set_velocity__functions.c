...
wzlscheduler_interfaces__srv__RobotSetVelocity_Request__are_equal(const wzlscheduler_interfaces__srv__RobotSetVelocity_Request * lhs, const wzlscheduler_interfaces__srv__RobotSetVelocity_Request * rhs)
{
  ...
  // velocityscalingfactor
  if (lhs->velocityscalingfactor != rhs->velocityscalingfactor) {
    return false;
  }
  // accelerationscalingfactor
  if (lhs->accelerationscalingfactor != rhs->accelerationscalingfactor) {
    return false;
  }
  // type
  ...
  wzlscheduler_interfaces__srv__RobotSetVelocity_Request * output)
{
  ...
  // velocityscalingfactor
  output->velocityscalingfactor = input->velocityscalingfactor;
  // accelerationscalingfactor
  output->accelerationscalingfactor = input->accelerationscalingfactor;
  // type
