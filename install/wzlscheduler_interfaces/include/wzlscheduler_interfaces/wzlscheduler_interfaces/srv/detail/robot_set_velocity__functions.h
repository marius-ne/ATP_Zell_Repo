...
#ifndef WZLSCHEDULER_INTERFACES__SRV__DETAIL__ROBOT_SET_VELOCITY__FUNCTIONS_H_
#define WZLSCHEDULER_INTERFACES__SRV__DETAIL__ROBOT_SET_VELOCITY__FUNCTIONS_H_
...
/// Initialize srv/RobotSetVelocity message.
/**
...
/// Finalize srv/RobotSetVelocity message.
/**
...
/// Create srv/RobotSetVelocity message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Request__init().
...
/// Destroy srv/RobotSetVelocity message.
/**
 * It calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Request__fini()
...
/// Check for srv/RobotSetVelocity message equality.
/**
...
/// Copy a srv/RobotSetVelocity message.
/**
...
/// Initialize array of srv/RobotSetVelocity messages.
/**
...
/// Finalize array of srv/RobotSetVelocity messages.
/**
 * It calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Request__fini()
...
/// Create array of srv/RobotSetVelocity messages.
/**
 * It allocates the memory for the array and calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotSetVelocity messages.
/**
 * It calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RobotSetVelocity message array equality.
/**
...
/// Copy an array of srv/RobotSetVelocity messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wzlscheduler_interfaces
...
/**
 * It calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_wzlscheduler_interfaces
...
/**
 * It allocates the memory for the array and calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wzlscheduler_interfaces
...
/**
 * It calls
 * wzlscheduler_interfaces__srv__RobotSetVelocity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WZLSCHEDULER_INTERFACES__SRV__DETAIL__ROBOT_SET_VELOCITY__FUNCTIONS_H_
