...
#ifndef WZLSCHEDULER_INTERFACES__SRV__DETAIL__SCENE_OBJECT_SET_POSE__FUNCTIONS_H_
#define WZLSCHEDULER_INTERFACES__SRV__DETAIL__SCENE_OBJECT_SET_POSE__FUNCTIONS_H_
...
/// Initialize srv/SceneObjectSetPose message.
/**
...
/// Finalize srv/SceneObjectSetPose message.
/**
...
/// Create srv/SceneObjectSetPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Request__init().
...
/// Destroy srv/SceneObjectSetPose message.
/**
 * It calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Request__fini()
...
/// Check for srv/SceneObjectSetPose message equality.
/**
...
/// Copy a srv/SceneObjectSetPose message.
/**
...
/// Initialize array of srv/SceneObjectSetPose messages.
/**
...
/// Finalize array of srv/SceneObjectSetPose messages.
/**
 * It calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Request__fini()
...
/// Create array of srv/SceneObjectSetPose messages.
/**
 * It allocates the memory for the array and calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SceneObjectSetPose messages.
/**
 * It calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SceneObjectSetPose message array equality.
/**
...
/// Copy an array of srv/SceneObjectSetPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wzlscheduler_interfaces
...
/**
 * It calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_wzlscheduler_interfaces
...
/**
 * It allocates the memory for the array and calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wzlscheduler_interfaces
...
/**
 * It calls
 * wzlscheduler_interfaces__srv__SceneObjectSetPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WZLSCHEDULER_INTERFACES__SRV__DETAIL__SCENE_OBJECT_SET_POSE__FUNCTIONS_H_
