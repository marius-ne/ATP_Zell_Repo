...
bool wzlscheduler_interfaces__msg__labeled_point_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wzlscheduler_interfaces.msg._labeled_point_cloud.LabeledPointCloud", full_classname_dest, 66) == 0);
  }
  wzlscheduler_interfaces__msg__LabeledPointCloud * ros_message = _ros_message;
  {  // label
...
PyObject * wzlscheduler_interfaces__msg__labeled_point_cloud__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wzlscheduler_interfaces.msg._labeled_point_cloud");
