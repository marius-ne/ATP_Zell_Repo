...
bool wzlscheduler_interfaces__msg__labeled_bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wzlscheduler_interfaces.msg._labeled_bounding_box.LabeledBoundingBox", full_classname_dest, 68) == 0);
  }
  wzlscheduler_interfaces__msg__LabeledBoundingBox * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of LabeledBoundingBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wzlscheduler_interfaces.msg._labeled_bounding_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LabeledBoundingBox");
