...
{
  new (message_memory) robo_planner_msgs::msg::LabeledPointClouds(_init);
}

void LabeledPointClouds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_planner_msgs::msg::LabeledPointClouds *>(message_memory);
  typed_message->~LabeledPointClouds();
}

size_t size_function__LabeledPointClouds__elements(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<robo_planner_msgs::msg::LabeledPointCloud> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robo_planner_msgs::msg::LabeledPointCloud> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robo_planner_msgs::msg::LabeledPointCloud> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const robo_planner_msgs::msg::LabeledPointCloud *>(
    get_const_function__LabeledPointClouds__elements(untyped_member, index));
  auto & value = *reinterpret_cast<robo_planner_msgs::msg::LabeledPointCloud *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<robo_planner_msgs::msg::LabeledPointCloud *>(
    get_function__LabeledPointClouds__elements(untyped_member, index));
  const auto & value = *reinterpret_cast<const robo_planner_msgs::msg::LabeledPointCloud *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LabeledPointClouds_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robo_planner_msgs::msg::LabeledPointCloud>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(robo_planner_msgs::msg::LabeledPointClouds, elements),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LabeledPointClouds_message_members = {
  ...
  1,  // number of fields
  sizeof(robo_planner_msgs::msg::LabeledPointClouds),
...
{
  return &::robo_planner_msgs::msg::rosidl_typesupport_introspection_cpp::LabeledPointClouds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, msg, LabeledPointClouds)() {
  return &::robo_planner_msgs::msg::rosidl_typesupport_introspection_cpp::LabeledPointClouds_message_type_support_handle;
}
