...
#ifndef ROBO_PLANNER_MSGS__SRV__DETAIL__FOLLOW_TRAJECTORY__FUNCTIONS_H_
#define ROBO_PLANNER_MSGS__SRV__DETAIL__FOLLOW_TRAJECTORY__FUNCTIONS_H_
...
/// Initialize srv/FollowTrajectory message.
/**
...
/// Finalize srv/FollowTrajectory message.
/**
...
/// Create srv/FollowTrajectory message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_planner_msgs__srv__FollowTrajectory_Request__init().
...
/// Destroy srv/FollowTrajectory message.
/**
 * It calls
 * robo_planner_msgs__srv__FollowTrajectory_Request__fini()
...
/// Check for srv/FollowTrajectory message equality.
/**
...
/// Copy a srv/FollowTrajectory message.
/**
...
/// Initialize array of srv/FollowTrajectory messages.
/**
...
/// Finalize array of srv/FollowTrajectory messages.
/**
 * It calls
 * robo_planner_msgs__srv__FollowTrajectory_Request__fini()
...
/// Create array of srv/FollowTrajectory messages.
/**
 * It allocates the memory for the array and calls
 * robo_planner_msgs__srv__FollowTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FollowTrajectory messages.
/**
 * It calls
 * robo_planner_msgs__srv__FollowTrajectory_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FollowTrajectory message array equality.
/**
...
/// Copy an array of srv/FollowTrajectory messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_planner_msgs__srv__FollowTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_planner_msgs
...
/**
 * It calls
 * robo_planner_msgs__srv__FollowTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_planner_msgs
...
/**
 * It allocates the memory for the array and calls
 * robo_planner_msgs__srv__FollowTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_planner_msgs
...
/**
 * It calls
 * robo_planner_msgs__srv__FollowTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBO_PLANNER_MSGS__SRV__DETAIL__FOLLOW_TRAJECTORY__FUNCTIONS_H_
