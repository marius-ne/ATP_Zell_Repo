...
static const _FollowTrajectory_Request_type_support_symbol_names_t _FollowTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, FollowTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_planner_msgs, srv, FollowTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_planner_msgs, srv, FollowTrajectory_Request)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_c::FollowTrajectory_Request_message_type_support_handle;
}
...
static const _FollowTrajectory_Response_type_support_symbol_names_t _FollowTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, FollowTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_planner_msgs, srv, FollowTrajectory_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_planner_msgs, srv, FollowTrajectory_Response)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_c::FollowTrajectory_Response_message_type_support_handle;
}
...
static const _FollowTrajectory_type_support_symbol_names_t _FollowTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, FollowTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_planner_msgs, srv, FollowTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robo_planner_msgs, srv, FollowTrajectory)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_c::FollowTrajectory_service_type_support_handle;
}
