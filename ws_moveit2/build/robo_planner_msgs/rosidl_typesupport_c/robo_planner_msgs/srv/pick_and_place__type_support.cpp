...
static const _PickAndPlace_Request_type_support_symbol_names_t _PickAndPlace_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, PickAndPlace_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_planner_msgs, srv, PickAndPlace_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_planner_msgs, srv, PickAndPlace_Request)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_c::PickAndPlace_Request_message_type_support_handle;
}
...
static const _PickAndPlace_Response_type_support_symbol_names_t _PickAndPlace_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, PickAndPlace_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_planner_msgs, srv, PickAndPlace_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_planner_msgs, srv, PickAndPlace_Response)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_c::PickAndPlace_Response_message_type_support_handle;
}
...
static const _PickAndPlace_type_support_symbol_names_t _PickAndPlace_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, PickAndPlace)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_planner_msgs, srv, PickAndPlace)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robo_planner_msgs, srv, PickAndPlace)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_c::PickAndPlace_service_type_support_handle;
}
