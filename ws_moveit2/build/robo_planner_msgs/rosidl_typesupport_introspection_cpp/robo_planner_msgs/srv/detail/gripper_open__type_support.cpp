...
{
  new (message_memory) robo_planner_msgs::srv::GripperOpen_Request(_init);
}

void GripperOpen_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_planner_msgs::srv::GripperOpen_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperOpen_Request_message_member_array[1] = {
  {
    ...
    offsetof(robo_planner_msgs::srv::GripperOpen_Request, dummyinput),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperOpen_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(robo_planner_msgs::srv::GripperOpen_Request),
...
{
  return &::robo_planner_msgs::srv::rosidl_typesupport_introspection_cpp::GripperOpen_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, srv, GripperOpen_Request)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_introspection_cpp::GripperOpen_Request_message_type_support_handle;
}
...
void GripperOpen_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) robo_planner_msgs::srv::GripperOpen_Response(_init);
}

void GripperOpen_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_planner_msgs::srv::GripperOpen_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperOpen_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_planner_msgs::srv::GripperOpen_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperOpen_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(robo_planner_msgs::srv::GripperOpen_Response),
...
{
  return &::robo_planner_msgs::srv::rosidl_typesupport_introspection_cpp::GripperOpen_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, srv, GripperOpen_Response)() {
  return &::robo_planner_msgs::srv::rosidl_typesupport_introspection_cpp::GripperOpen_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GripperOpen_service_members = {
  ...
  // see get_service_type_support_handle<robo_planner_msgs::srv::GripperOpen>()
...
get_service_type_support_handle<robo_planner_msgs::srv::GripperOpen>()
{
  ...
  auto service_type_support =
    &::robo_planner_msgs::srv::rosidl_typesupport_introspection_cpp::GripperOpen_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, srv, GripperOpen)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<robo_planner_msgs::srv::GripperOpen>();
}
