...
#include "robo_planner_msgs/msg/detail/labeled_point_cloud__rosidl_typesupport_fastrtps_c.h"
...
using _LabeledPointCloud__ros_msg_type = robo_planner_msgs__msg__LabeledPointCloud;
...
static uint32_t _LabeledPointCloud__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_planner_msgs__msg__LabeledPointCloud(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo_planner_msgs__msg__LabeledPointCloud;
    is_plain =
      (
...
static size_t _LabeledPointCloud__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo_planner_msgs__msg__LabeledPointCloud(
