...
#include "robo_planner_msgs/msg/detail/scene_object_add__rosidl_typesupport_fastrtps_c.h"
...
using _SceneObjectAdd__ros_msg_type = robo_planner_msgs__msg__SceneObjectAdd;
...
size_t get_serialized_size_robo_planner_msgs__msg__SceneObjectAdd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SceneObjectAdd__ros_msg_type * ros_message = static_cast<const _SceneObjectAdd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SceneObjectAdd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_planner_msgs__msg__SceneObjectAdd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_planner_msgs
size_t max_serialized_size_robo_planner_msgs__msg__SceneObjectAdd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo_planner_msgs__msg__SceneObjectAdd;
    is_plain =
      (
...
static size_t _SceneObjectAdd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo_planner_msgs__msg__SceneObjectAdd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, msg, SceneObjectAdd)() {
