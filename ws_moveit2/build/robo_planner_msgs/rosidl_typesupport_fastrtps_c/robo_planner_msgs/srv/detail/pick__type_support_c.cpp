...
#include "robo_planner_msgs/srv/detail/pick__rosidl_typesupport_fastrtps_c.h"
...
using _Pick_Request__ros_msg_type = robo_planner_msgs__srv__Pick_Request;
...
size_t get_serialized_size_robo_planner_msgs__srv__Pick_Request(
  const void * untyped_ros_message,
...
static uint32_t _Pick_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_planner_msgs__srv__Pick_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_planner_msgs
size_t max_serialized_size_robo_planner_msgs__srv__Pick_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo_planner_msgs__srv__Pick_Request;
    is_plain =
      (
...
static size_t _Pick_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo_planner_msgs__srv__Pick_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, Pick_Request)() {
...
using _Pick_Response__ros_msg_type = robo_planner_msgs__srv__Pick_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_planner_msgs
size_t get_serialized_size_robo_planner_msgs__srv__Pick_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pick_Response__ros_msg_type * ros_message = static_cast<const _Pick_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_planner_msgs__srv__Pick_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_planner_msgs
size_t max_serialized_size_robo_planner_msgs__srv__Pick_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robo_planner_msgs__srv__Pick_Response;
    is_plain =
      (
...
static size_t _Pick_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo_planner_msgs__srv__Pick_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, Pick_Response)() {
...
// already included above
// #include "robo_planner_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robo_planner_msgs/srv/pick.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_planner_msgs, srv, Pick)() {
  return &Pick__handle;
}
