...
#include "robo_planner_msgs/srv/detail/move_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robo_planner_msgs::srv::MoveToPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robo_planner_msgs::srv::MoveToPose_Request & ros_message)
{
  // Member: dummyinput
  cdr >> ros_message.dummyinput;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo_planner_msgs::srv::MoveToPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robo_planner_msgs::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_planner_msgs::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, srv, MoveToPose_Request)() {
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robo_planner_msgs
cdr_serialize(
  const robo_planner_msgs::srv::MoveToPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robo_planner_msgs::srv::MoveToPose_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robo_planner_msgs::srv::MoveToPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robo_planner_msgs::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robo_planner_msgs::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, srv, MoveToPose_Response)() {
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
{
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, srv, MoveToPose)() {
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
