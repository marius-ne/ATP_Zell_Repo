...
#include "robo_planner_msgs/msg/detail/labeled_point_cloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robo_planner_msgs::msg::LabeledPointCloud & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robo_planner_msgs::msg::LabeledPointCloud & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo_planner_msgs::msg::LabeledPointCloud;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robo_planner_msgs::msg::LabeledPointCloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_planner_msgs::msg::LabeledPointCloud *>(
    untyped_ros_message);
...
{
  return &robo_planner_msgs::msg::typesupport_fastrtps_cpp::_LabeledPointCloud__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, msg, LabeledPointCloud)() {
  return &robo_planner_msgs::msg::typesupport_fastrtps_cpp::_LabeledPointCloud__handle;
}
