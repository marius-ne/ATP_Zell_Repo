...
#include "ur16e_interfaces/msg/detail/target_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ur16e_interfaces::msg::TargetPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur16e_interfaces::msg::TargetPose & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur16e_interfaces::msg::TargetPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur16e_interfaces::msg::TargetPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur16e_interfaces::msg::TargetPose *>(
    untyped_ros_message);
...
get_message_type_support_handle<ur16e_interfaces::msg::TargetPose>()
{
  return &ur16e_interfaces::msg::typesupport_fastrtps_cpp::_TargetPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur16e_interfaces, msg, TargetPose)() {
  return &ur16e_interfaces::msg::typesupport_fastrtps_cpp::_TargetPose__handle;
}
