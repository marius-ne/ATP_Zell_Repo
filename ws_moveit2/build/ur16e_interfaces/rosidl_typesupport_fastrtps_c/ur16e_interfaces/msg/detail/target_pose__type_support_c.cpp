...
#include "ur16e_interfaces/msg/detail/target_pose__rosidl_typesupport_fastrtps_c.h"
...
using _TargetPose__ros_msg_type = ur16e_interfaces__msg__TargetPose;
...
size_t get_serialized_size_ur16e_interfaces__msg__TargetPose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TargetPose__ros_msg_type * ros_message = static_cast<const _TargetPose__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TargetPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur16e_interfaces__msg__TargetPose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur16e_interfaces
size_t max_serialized_size_ur16e_interfaces__msg__TargetPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur16e_interfaces__msg__TargetPose;
    is_plain =
      (
...
static size_t _TargetPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur16e_interfaces__msg__TargetPose(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur16e_interfaces, msg, TargetPose)() {
