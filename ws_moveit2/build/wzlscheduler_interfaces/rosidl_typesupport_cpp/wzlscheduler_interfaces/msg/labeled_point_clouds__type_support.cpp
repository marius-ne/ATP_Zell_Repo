...
static const _LabeledPointClouds_type_support_symbol_names_t _LabeledPointClouds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wzlscheduler_interfaces, msg, LabeledPointClouds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wzlscheduler_interfaces, msg, LabeledPointClouds)),
  }
};
...
{
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_cpp::LabeledPointClouds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wzlscheduler_interfaces, msg, LabeledPointClouds)() {
  return get_message_type_support_handle<wzlscheduler_interfaces::msg::LabeledPointClouds>();
}
