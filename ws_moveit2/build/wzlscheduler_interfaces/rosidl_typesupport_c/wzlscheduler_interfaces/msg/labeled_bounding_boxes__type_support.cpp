...
static const _LabeledBoundingBoxes_type_support_symbol_names_t _LabeledBoundingBoxes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, msg, LabeledBoundingBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, msg, LabeledBoundingBoxes)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, msg, LabeledBoundingBoxes)() {
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_c::LabeledBoundingBoxes_message_type_support_handle;
}
