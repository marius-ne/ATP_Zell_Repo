...
static const _LabeledPointClouds_type_support_symbol_names_t _LabeledPointClouds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, msg, LabeledPointClouds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, msg, LabeledPointClouds)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, msg, LabeledPointClouds)() {
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_c::LabeledPointClouds_message_type_support_handle;
}
