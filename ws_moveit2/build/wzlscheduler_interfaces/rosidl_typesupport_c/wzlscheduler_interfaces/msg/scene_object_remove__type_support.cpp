...
static const _SceneObjectRemove_type_support_symbol_names_t _SceneObjectRemove_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, msg, SceneObjectRemove)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, msg, SceneObjectRemove)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, msg, SceneObjectRemove)() {
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_c::SceneObjectRemove_message_type_support_handle;
}
