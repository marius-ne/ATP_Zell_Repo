...
static const _SceneObjectDetach_Request_type_support_symbol_names_t _SceneObjectDetach_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, SceneObjectDetach_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, SceneObjectDetach_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, SceneObjectDetach_Request)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::SceneObjectDetach_Request_message_type_support_handle;
}
...
static const _SceneObjectDetach_Response_type_support_symbol_names_t _SceneObjectDetach_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, SceneObjectDetach_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, SceneObjectDetach_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, SceneObjectDetach_Response)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::SceneObjectDetach_Response_message_type_support_handle;
}
...
static const _SceneObjectDetach_type_support_symbol_names_t _SceneObjectDetach_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, SceneObjectDetach)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, SceneObjectDetach)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, SceneObjectDetach)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::SceneObjectDetach_service_type_support_handle;
}
