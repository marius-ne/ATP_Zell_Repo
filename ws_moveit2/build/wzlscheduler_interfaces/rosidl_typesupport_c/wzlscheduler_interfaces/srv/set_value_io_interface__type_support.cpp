...
static const _SetValueIoInterface_Request_type_support_symbol_names_t _SetValueIoInterface_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, SetValueIoInterface_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, SetValueIoInterface_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, SetValueIoInterface_Request)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::SetValueIoInterface_Request_message_type_support_handle;
}
...
static const _SetValueIoInterface_Response_type_support_symbol_names_t _SetValueIoInterface_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, SetValueIoInterface_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, SetValueIoInterface_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, SetValueIoInterface_Response)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::SetValueIoInterface_Response_message_type_support_handle;
}
...
static const _SetValueIoInterface_type_support_symbol_names_t _SetValueIoInterface_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, SetValueIoInterface)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, SetValueIoInterface)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, SetValueIoInterface)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::SetValueIoInterface_service_type_support_handle;
}
