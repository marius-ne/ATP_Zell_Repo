...
static const _RobotFollowTrajectory_Request_type_support_symbol_names_t _RobotFollowTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory_Request)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::RobotFollowTrajectory_Request_message_type_support_handle;
}
...
static const _RobotFollowTrajectory_Response_type_support_symbol_names_t _RobotFollowTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory_Response)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::RobotFollowTrajectory_Response_message_type_support_handle;
}
...
static const _RobotFollowTrajectory_type_support_symbol_names_t _RobotFollowTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, srv, RobotFollowTrajectory)() {
  return &::wzlscheduler_interfaces::srv::rosidl_typesupport_c::RobotFollowTrajectory_service_type_support_handle;
}
