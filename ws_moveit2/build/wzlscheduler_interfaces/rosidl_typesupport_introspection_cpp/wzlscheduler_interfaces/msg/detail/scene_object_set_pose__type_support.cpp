...
{
  new (message_memory) wzlscheduler_interfaces::msg::SceneObjectSetPose(_init);
}

void SceneObjectSetPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wzlscheduler_interfaces::msg::SceneObjectSetPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SceneObjectSetPose_message_member_array[2] = {
  {
    ...
    offsetof(wzlscheduler_interfaces::msg::SceneObjectSetPose, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wzlscheduler_interfaces::msg::SceneObjectSetPose, coordinates),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SceneObjectSetPose_message_members = {
  ...
  2,  // number of fields
  sizeof(wzlscheduler_interfaces::msg::SceneObjectSetPose),
...
{
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_introspection_cpp::SceneObjectSetPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wzlscheduler_interfaces, msg, SceneObjectSetPose)() {
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_introspection_cpp::SceneObjectSetPose_message_type_support_handle;
}
