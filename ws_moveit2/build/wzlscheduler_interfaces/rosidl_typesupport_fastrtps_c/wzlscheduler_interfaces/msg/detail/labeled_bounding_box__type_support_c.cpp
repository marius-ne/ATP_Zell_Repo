...
#include "wzlscheduler_interfaces/msg/detail/labeled_bounding_box__rosidl_typesupport_fastrtps_c.h"
...
using _LabeledBoundingBox__ros_msg_type = wzlscheduler_interfaces__msg__LabeledBoundingBox;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LabeledBoundingBox__ros_msg_type * ros_message = static_cast<const _LabeledBoundingBox__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LabeledBoundingBox__ros_msg_type * ros_message = static_cast<_LabeledBoundingBox__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _LabeledBoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wzlscheduler_interfaces__msg__LabeledBoundingBox(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wzlscheduler_interfaces__msg__LabeledBoundingBox;
    is_plain =
      (
...
static size_t _LabeledBoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wzlscheduler_interfaces__msg__LabeledBoundingBox(
...
static message_type_support_callbacks_t __callbacks_LabeledBoundingBox = {
...
static rosidl_message_type_support_t _LabeledBoundingBox__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LabeledBoundingBox,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, msg, LabeledBoundingBox)() {
  return &_LabeledBoundingBox__type_support;
}
