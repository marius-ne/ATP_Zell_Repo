...
static const _SensorReadRequest_type_support_symbol_names_t _SensorReadRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opcua_interfaces_io_link, msg, SensorReadRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opcua_interfaces_io_link, msg, SensorReadRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opcua_interfaces_io_link, msg, SensorReadRequest)() {
  return &::opcua_interfaces_io_link::msg::rosidl_typesupport_c::SensorReadRequest_message_type_support_handle;
}
