...
#include "opcua_interfaces_io_link/msg/detail/sensor_read__rosidl_typesupport_fastrtps_c.h"
...
using _SensorRead__ros_msg_type = opcua_interfaces_io_link__msg__SensorRead;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SensorRead__ros_msg_type * ros_message = static_cast<const _SensorRead__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: sensor_value_bool
  {
    cdr << (ros_message->sensor_value_bool ? true : false);
  }

  // Field name: sensor_value_int
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SensorRead__ros_msg_type * ros_message = static_cast<_SensorRead__ros_msg_type *>(untyped_ros_message);
  // Field name: sensor_id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_opcua_interfaces_io_link__msg__SensorRead(
  const void * untyped_ros_message,
...
static uint32_t _SensorRead__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_opcua_interfaces_io_link__msg__SensorRead(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_opcua_interfaces_io_link
size_t max_serialized_size_opcua_interfaces_io_link__msg__SensorRead(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opcua_interfaces_io_link__msg__SensorRead;
    is_plain =
      (
...
static size_t _SensorRead__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_opcua_interfaces_io_link__msg__SensorRead(
...
static message_type_support_callbacks_t __callbacks_SensorRead = {
...
static rosidl_message_type_support_t _SensorRead__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SensorRead,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opcua_interfaces_io_link, msg, SensorRead)() {
  return &_SensorRead__type_support;
}
