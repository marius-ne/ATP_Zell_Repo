...
static const _ActuatorReadRequest_type_support_symbol_names_t _ActuatorReadRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opcua_interfaces, msg, ActuatorReadRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, opcua_interfaces, msg, ActuatorReadRequest)),
  }
};
...
{
  return &::opcua_interfaces::msg::rosidl_typesupport_cpp::ActuatorReadRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, opcua_interfaces, msg, ActuatorReadRequest)() {
  return get_message_type_support_handle<opcua_interfaces::msg::ActuatorReadRequest>();
}
