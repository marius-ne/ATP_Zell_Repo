# Source: https://github.com/UniversalRobots/Universal_Robots_ROS2_Driver/blob/f499df8c94452ff223cc4e396374f9235f166f29/ur_moveit_config/launch/ur_moveit.launch.py
# Date: 26 Oct 2023
# Author: Ravi Joshi
#   * Minor modifications are done to adapt to Pilz Industrial Motion Planner
...
def launch_setup(context, *args, **kwargs):
    ...
    pilz_planning_yaml = load_yaml("ur_pilz", "config/pilz_industrial_motion_planner_planning.yaml")
    planning_pipeline_config["pilz_industrial_motion_planner"].update(pilz_planning_yaml) 

    pilz_cartesian_limits_yaml = load_yaml("ur_pilz", "config/pilz_cartesian_limits.yaml")
    ...
    planning_scene_monitor_parameters = {
        ...
        "publish_robot_description":True, # newly added
        "publish_robot_description_semantic":True, # newly added
    }
