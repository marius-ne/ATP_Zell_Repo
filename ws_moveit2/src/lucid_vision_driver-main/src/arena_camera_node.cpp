...
#include "../include/arena_camera/arena_camera_node.h"

#include "../include/arena_camera/camera_settings.h"
...
{
  RCLCPP_INFO(this->get_logger(), "Starting node for camera driver.");

  RCLCPP_INFO(this->get_logger(), "Read camera settings.");
  auto camera_settings = read_camera_settings();

  RCLCPP_INFO(this->get_logger(), "Create camera handler.");
  m_arena_camera_handler = std::make_unique<ArenaCamerasHandler>();

  RCLCPP_INFO(this->get_logger(), "Create camera from settings.");
  m_arena_camera_handler->create_camera_from_settings(camera_settings);
  this->m_frame_id = camera_settings.get_frame_id();

  RCLCPP_INFO(this->get_logger(), "Init camera info.");
  ...
  RCLCPP_INFO(this->get_logger(), "Create camera info publisher.");
  ...
  RCLCPP_INFO(this->get_logger(), "Set callbacks.");
