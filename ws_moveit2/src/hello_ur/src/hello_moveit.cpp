...
int main(int argc, char* argv[])
{
  ...
  std::string modelName = "ur_manipulator";
  using moveit::planning_interface::MoveGroupInterface;
  std::cout << "Try to load robot model: " << modelName.c_str() << std::endl;
  auto move_group_interface = MoveGroupInterface(node, modelName);

std::cout << "Try to set visual tools" << std::endl;
