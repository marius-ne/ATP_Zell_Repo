...
class publisher_to_client(Node):
    ...
    def __init__(self):
        ...
        msg_write.actuator_command_bool1 = True
        msg_write.actuator_command_bool2 = False
        msg_write.actuator_id = 'ns=4;i=5040'
        msg_write.actuator_write_type = 2
        ...
        msg_read_request.actuator_id = 'ns=4;i=5040' # Actuator ID
        msg_read_request.actuator_read_type = 2
