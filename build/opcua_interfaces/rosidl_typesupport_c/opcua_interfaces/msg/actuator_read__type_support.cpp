...
static const _ActuatorRead_type_support_symbol_names_t _ActuatorRead_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opcua_interfaces, msg, ActuatorRead)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opcua_interfaces, msg, ActuatorRead)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opcua_interfaces, msg, ActuatorRead)() {
  return &::opcua_interfaces::msg::rosidl_typesupport_c::ActuatorRead_message_type_support_handle;
}
