...
bool wzlscheduler_interfaces__srv__robot_set_velocity__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // velocityscalingfactor
    PyObject * field = PyObject_GetAttrString(_pymsg, "velocityscalingfactor");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->velocityscalingfactor = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // accelerationscalingfactor
    PyObject * field = PyObject_GetAttrString(_pymsg, "accelerationscalingfactor");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->accelerationscalingfactor = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // type
...
PyObject * wzlscheduler_interfaces__srv__robot_set_velocity__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // velocityscalingfactor
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->velocityscalingfactor);
    {
      int rc = PyObject_SetAttrString(_pymessage, "velocityscalingfactor", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // accelerationscalingfactor
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->accelerationscalingfactor);
    {
      int rc = PyObject_SetAttrString(_pymessage, "accelerationscalingfactor", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
