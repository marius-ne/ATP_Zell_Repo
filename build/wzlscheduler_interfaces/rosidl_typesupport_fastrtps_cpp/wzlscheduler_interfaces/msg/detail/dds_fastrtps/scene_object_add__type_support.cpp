...
#include "wzlscheduler_interfaces/msg/detail/scene_object_add__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wzlscheduler_interfaces::msg::SceneObjectAdd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wzlscheduler_interfaces::msg::SceneObjectAdd & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wzlscheduler_interfaces::msg::SceneObjectAdd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wzlscheduler_interfaces::msg::SceneObjectAdd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wzlscheduler_interfaces::msg::SceneObjectAdd *>(
    untyped_ros_message);
...
{
  return &wzlscheduler_interfaces::msg::typesupport_fastrtps_cpp::_SceneObjectAdd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wzlscheduler_interfaces, msg, SceneObjectAdd)() {
  return &wzlscheduler_interfaces::msg::typesupport_fastrtps_cpp::_SceneObjectAdd__handle;
}
