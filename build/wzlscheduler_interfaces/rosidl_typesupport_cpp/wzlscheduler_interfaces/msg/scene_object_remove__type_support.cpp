...
static const _SceneObjectRemove_type_support_symbol_names_t _SceneObjectRemove_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wzlscheduler_interfaces, msg, SceneObjectRemove)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wzlscheduler_interfaces, msg, SceneObjectRemove)),
  }
};
...
{
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_cpp::SceneObjectRemove_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wzlscheduler_interfaces, msg, SceneObjectRemove)() {
  return get_message_type_support_handle<wzlscheduler_interfaces::msg::SceneObjectRemove>();
}
