...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__init(wzlscheduler_interfaces__srv__SceneObjectAttach_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    wzlscheduler_interfaces__srv__SceneObjectAttach_Request__fini(msg);
    return false;
  }
  // parentkey
  if (!rosidl_runtime_c__String__init(&msg->parentkey)) {
    wzlscheduler_interfaces__srv__SceneObjectAttach_Request__fini(msg);
    return false;
  }
  return true;
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__fini(wzlscheduler_interfaces__srv__SceneObjectAttach_Request * msg)
{
  ...
  // parentkey
  rosidl_runtime_c__String__fini(&msg->parentkey);
}
  ...
  wzlscheduler_interfaces__srv__SceneObjectAttach_Request * output)
{
  ...
  // parentkey
  if (!rosidl_runtime_c__String__copy(
      &(input->parentkey), &(output->parentkey)))
  {
    return false;
  }
  return true;
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__create()
{
  ...
  wzlscheduler_interfaces__srv__SceneObjectAttach_Request * msg = (wzlscheduler_interfaces__srv__SceneObjectAttach_Request *)allocator.allocate(sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Request));
  bool success = wzlscheduler_interfaces__srv__SceneObjectAttach_Request__init(msg);
  if (!success) {
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence__init(wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wzlscheduler_interfaces__srv__SceneObjectAttach_Request * data = NULL;

  if (size) {
    data = (wzlscheduler_interfaces__srv__SceneObjectAttach_Request *)allocator.zero_allocate(size, sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = wzlscheduler_interfaces__srv__SceneObjectAttach_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        wzlscheduler_interfaces__srv__SceneObjectAttach_Request__fini(&data[i - 1]);
      }
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence__fini(wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      wzlscheduler_interfaces__srv__SceneObjectAttach_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * array = (wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence *)allocator.allocate(sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence__init(array, size);
  if (!success) {
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence__destroy(wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence__are_equal(const wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * lhs, const wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!wzlscheduler_interfaces__srv__SceneObjectAttach_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  wzlscheduler_interfaces__srv__SceneObjectAttach_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    wzlscheduler_interfaces__srv__SceneObjectAttach_Request * data =
      (wzlscheduler_interfaces__srv__SceneObjectAttach_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!wzlscheduler_interfaces__srv__SceneObjectAttach_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          wzlscheduler_interfaces__srv__SceneObjectAttach_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!wzlscheduler_interfaces__srv__SceneObjectAttach_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wzlscheduler_interfaces__srv__SceneObjectAttach_Response * msg = (wzlscheduler_interfaces__srv__SceneObjectAttach_Response *)allocator.allocate(sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Response));
  bool success = wzlscheduler_interfaces__srv__SceneObjectAttach_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Response__destroy(wzlscheduler_interfaces__srv__SceneObjectAttach_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    wzlscheduler_interfaces__srv__SceneObjectAttach_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence__init(wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wzlscheduler_interfaces__srv__SceneObjectAttach_Response * data = NULL;

  if (size) {
    data = (wzlscheduler_interfaces__srv__SceneObjectAttach_Response *)allocator.zero_allocate(size, sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = wzlscheduler_interfaces__srv__SceneObjectAttach_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        wzlscheduler_interfaces__srv__SceneObjectAttach_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence__fini(wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      wzlscheduler_interfaces__srv__SceneObjectAttach_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * array = (wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence *)allocator.allocate(sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence__destroy(wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence__are_equal(const wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * lhs, const wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!wzlscheduler_interfaces__srv__SceneObjectAttach_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  wzlscheduler_interfaces__srv__SceneObjectAttach_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(wzlscheduler_interfaces__srv__SceneObjectAttach_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    wzlscheduler_interfaces__srv__SceneObjectAttach_Response * data =
      (wzlscheduler_interfaces__srv__SceneObjectAttach_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!wzlscheduler_interfaces__srv__SceneObjectAttach_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          wzlscheduler_interfaces__srv__SceneObjectAttach_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!wzlscheduler_interfaces__srv__SceneObjectAttach_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
