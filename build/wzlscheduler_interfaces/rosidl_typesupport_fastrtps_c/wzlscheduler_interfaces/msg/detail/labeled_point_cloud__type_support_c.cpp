...
#include "wzlscheduler_interfaces/msg/detail/labeled_point_cloud__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // posecad, poseorigin
...
using _LabeledPointCloud__ros_msg_type = wzlscheduler_interfaces__msg__LabeledPointCloud;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LabeledPointCloud__ros_msg_type * ros_message = static_cast<const _LabeledPointCloud__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LabeledPointCloud__ros_msg_type * ros_message = static_cast<_LabeledPointCloud__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _LabeledPointCloud__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wzlscheduler_interfaces__msg__LabeledPointCloud(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wzlscheduler_interfaces__msg__LabeledPointCloud;
    is_plain =
      (
...
static size_t _LabeledPointCloud__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wzlscheduler_interfaces__msg__LabeledPointCloud(
...
static message_type_support_callbacks_t __callbacks_LabeledPointCloud = {
...
static rosidl_message_type_support_t _LabeledPointCloud__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LabeledPointCloud,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, msg, LabeledPointCloud)() {
  return &_LabeledPointCloud__type_support;
}
