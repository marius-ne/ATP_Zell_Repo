...
static const _SceneObjectSetPose_type_support_symbol_names_t _SceneObjectSetPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wzlscheduler_interfaces, msg, SceneObjectSetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wzlscheduler_interfaces, msg, SceneObjectSetPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wzlscheduler_interfaces, msg, SceneObjectSetPose)() {
  return &::wzlscheduler_interfaces::msg::rosidl_typesupport_c::SceneObjectSetPose_message_type_support_handle;
}
