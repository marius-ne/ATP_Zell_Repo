...
static const _MoveToPose_Request_type_support_symbol_names_t _MoveToPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, srv, MoveToPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, srv, MoveToPose_Request)),
  }
};
...
{
  return &::robo_planner_msgs::srv::rosidl_typesupport_cpp::MoveToPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_planner_msgs, srv, MoveToPose_Request)() {
  return get_message_type_support_handle<robo_planner_msgs::srv::MoveToPose_Request>();
}
...
static const _MoveToPose_Response_type_support_symbol_names_t _MoveToPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, srv, MoveToPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, srv, MoveToPose_Response)),
  }
};
...
{
  return &::robo_planner_msgs::srv::rosidl_typesupport_cpp::MoveToPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_planner_msgs, srv, MoveToPose_Response)() {
  return get_message_type_support_handle<robo_planner_msgs::srv::MoveToPose_Response>();
}
...
static const _MoveToPose_type_support_symbol_names_t _MoveToPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_planner_msgs, srv, MoveToPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_planner_msgs, srv, MoveToPose)),
  }
};
...
{
  return &::robo_planner_msgs::srv::rosidl_typesupport_cpp::MoveToPose_service_type_support_handle;
}
