...
class Metaclass_Place(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robo_planner_msgs.srv import _place
...
class Place(metaclass=Metaclass_Place):
    from robo_planner_msgs.srv._place import Place_Request as Request
    from robo_planner_msgs.srv._place import Place_Response as Response
