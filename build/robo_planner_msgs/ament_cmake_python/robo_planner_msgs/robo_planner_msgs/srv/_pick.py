...
class Metaclass_Pick(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robo_planner_msgs.srv import _pick
...
class Pick(metaclass=Metaclass_Pick):
    from robo_planner_msgs.srv._pick import Pick_Request as Request
    from robo_planner_msgs.srv._pick import Pick_Response as Response
