...
#include "robo_planner_msgs/srv/detail/pick__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robo_planner_msgs::srv::Pick_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robo_planner_msgs::srv::Pick_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_planner_msgs::srv::Pick_Request *>(
    untyped_ros_message);
...
{
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_Pick_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robo_planner_msgs::srv::Pick_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robo_planner_msgs::srv::Pick_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robo_planner_msgs::srv::Pick_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_Pick_Response__handle;
}
...
static rosidl_service_type_support_t _Pick__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Pick__callbacks,
...
{
  return &robo_planner_msgs::srv::typesupport_fastrtps_cpp::_Pick__handle;
}
